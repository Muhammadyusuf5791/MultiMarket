...
const Hero = () => {
  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-2">
      {/* Left content */}
      <div className="text-center md:text-left max-w-xl">
        ...
        <button
          className="bg-blue-500 mt-8 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-600 transition-all duration-300 ease"

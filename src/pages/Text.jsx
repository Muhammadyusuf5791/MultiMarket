...
const Text = () => {
  const { showMore } = useContext(Context);
      ...
      {showMore && (
        <div className="text-gray-700 text-base md:text-lg max-w-4xl mx-auto">
          ...
          <ul className="list-disc list-inside mb-6">
            ...
            <li>
              <strong>Tezkor yetkazib berish:</strong> O'zbekiston bo'ylab 1-3 kun ichida yetkazib berish xizmati.
            </li>
            <li>
          ...
          <button className="bg-blue-500 mt-4 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-600 transition-all duration-300 ease">
            Ro'yxatdan o'tish
          </button>
        </div>
      )}
